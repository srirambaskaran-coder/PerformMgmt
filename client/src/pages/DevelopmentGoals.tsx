        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">
              Track your professional development goals linked to your
              evaluations
            </p>
          </div>
          <Button
        ...
        {displayEligibleEvaluations.length === 0 && !isLoading && (
          <Card>
            <CardContent className="py-8 text-center">
              ...
              <p className="text-muted-foreground">
                Development goals can only be created after your evaluation
                meeting is completed and for active appraisal cycles. Complete
                your evaluations to start setting goals.
              </p>
            </CardContent>
          </Card>
        )}
          ...
          <Card>
            <CardContent className="py-8 text-center">
              ...
              <p className="text-muted-foreground mb-4">
                Start setting your development goals based on your completed
                evaluations.
              </p>
              <Button
                onClick={() => handleCreateGoal()}
              ...
              ([cycleKey, { cycle, goals: cycleGoals }]) => (
                <Card key={cycleKey}>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {cycleGoals.length} goal
                      {cycleGoals.length !== 1 ? "s" : ""} in this cycle
                    </CardDescription>
                  </CardHeader>
                          ...
                          {displayEligibleEvaluations.map((evaluation) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                {periodInfo}
                                {evaluation.goalsCount > 0 &&
                                  ` (${evaluation.goalsCount} goals)`}
                              </SelectItem>
                            );
                          })}
                        </SelectContent>
                ...
                {selectedGoal && (
                  <div className="p-3 bg-muted rounded-md text-sm space-y-1">
                    <div className="font-medium">
                      {selectedGoal.appraisalCycle?.code} -{" "}
                      {selectedGoal.appraisalCycle?.description}
                    </div>
