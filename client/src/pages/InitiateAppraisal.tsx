...
const initiateAppraisalSchema = z
  .object({
    appraisalType: z.enum([
      "questionnaire_based",
      "kpi_based",
      "mbo_based",
      "okr_based",
...
export default function InitiateAppraisal() {
  ...
  const { data: calendarDetails = [], isLoading: isLoadingDetails } = useQuery<
    FrequencyCalendarDetails[]
  >({
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <h3 className="text-lg font-semibold mb-2">
                No appraisal groups found
              </h3>
              <p className="text-muted-foreground text-center mb-4">
                {searchQuery
                  ? "No groups match your search criteria."
                  : "Create some appraisal groups first to initiate appraisals."}
              </p>
            </CardContent>
          </Card>
        ) : (
                ...
                >
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <MultiSelect
                                options={questionnaireTemplates.map(
                                  (template) => ({
                                    value: template.id,
                                    label: template.name,
                                  })
                            ...
                            <FormDescription>
                              Choose one or more questionnaire templates for
                              this appraisal
                            </FormDescription>
                            <FormMessage />
                          </FormItem>
                          ...
                          {uploadedFile ? (
                            ...
                            <div className="text-center">
                              ...
                              <p className="text-muted-foreground mb-2">
                                Upload{" "}
                                {appraisalType === "kpi_based" ? "KPI" : "MBO"}{" "}
                                document
                              </p>
                              <input
                                type="file"
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Optional: Link to a frequency calendar for automated
                            scheduling
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                        ...
                        {calendarDetails.length > 0 && (
                          <div className="space-y-4">
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormDescription>
                                    Choose one or more calendar periods for this
                                    appraisal cycle
                                  </FormDescription>
                                  <FormMessage />
                                </FormItem>
                            ...
                            {selectedCalendarDetailIds.length > 0 && (
                              <div className="space-y-4">
                                <p className="text-sm text-muted-foreground">
                                  Configure timing settings for selected
                                  calendar periods:
                                </p>
                                            ...
                                            render={({ field }) => (
                                              <FormItem>
                                                ...
                                                >
                                                  <FormControl>
                                                    <SelectTrigger
                                                      data-testid={`select-reminders-${detail.id}`}
                                                    >
                        ...
                        {calendarDetails.length === 0 && !isLoadingDetails && (
                          <Card className="p-6">
                            <div className="text-center text-muted-foreground">
                              ...
                              <p>
                                No calendar details found for this frequency
                                calendar.
                              </p>
                            </div>
                          </Card>
                  ...
                  <div className="space-y-4">
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                          <div className="space-y-0.5">
                            ...
                            <FormDescription>
                              Automatically exclude employees who joined less
                              than a year ago
                            </FormDescription>
                          </div>
                          <FormControl>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Select individual employees to exclude from this
                        appraisal cycle
                      </p>
                      ...
                      <ScrollArea className="h-40 border rounded-md p-4">
                        <div className="space-y-2">
                          {selectedGroup.members
                            .filter((member) => {
                              const dojFromDate =
                                form.watch("excludeDojFromDate");
                              const dojTillDate =
                                form.watch("excludeDojTillDate");
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="space-y-3">
                          <FormLabel>
                            When should the appraisal be published?
                          </FormLabel>
                          <FormControl>
                            <RadioGroup
                              onValueChange={field.onChange}
                            ...
                            >
                              <div className="flex items-center space-x-2">
                                ...
                                >
                                  <div>
                                    ...
                                    <div className="text-sm text-muted-foreground">
                                      Immediately initiate the questionnaire to
                                      all employees in the selected appraisal
                                      group
                                    </div>
                                  </div>
                                </Label>
                              ...
                              <div className="flex items-center space-x-2">
                                <RadioGroupItem
                                  value="as_per_calendar"
                                  id="publish-calendar"
                                  data-testid="radio-publish-calendar"
                                />
                                <Label
                                  htmlFor="publish-calendar"
                                  className="font-normal cursor-pointer"
                                >
                                  <div>
                                    <div className="font-medium">
                                      Publish As Per Calendar
                                    </div>
                                    <div className="text-sm text-muted-foreground">
                                      Publish the questionnaire on the scheduled
                                      date (end date of frequency calendar +
                                      days to initiate)
                                    </div>
                                  </div>
                                </Label>
                      ...
                      selectedCalendarDetailIds.length > 0 && (
                        <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                          <p className="text-sm text-blue-800 dark:text-blue-200">
                            <strong>Scheduled Publishing:</strong> The appraisal
                            will be published to employees based on each
                            selected calendar period's end date plus the
                            configured "Days to Initiate" value.
                          </p>
                          {form
                            ...
                            .map((timing: any) => {
                              ...
                              const daysToAdd =
                                Number(timing.daysToInitiate) || 0;
                              ...
                              return (
                                ...
                                >
                                  • {detail.displayName}: Will be published on{" "}
                                  <strong>
                                    {scheduledDate.toLocaleDateString()}
                                  </strong>{" "}
                                  ({endDate.toLocaleDateString()} + {daysToAdd}{" "}
                                  {daysToAdd === 1 ? "day" : "days"})
                                </p>
                              );
                            })}
                        </div>
