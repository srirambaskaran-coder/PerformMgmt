    ...
    <div className="space-y-6" data-testid="employee-dashboard">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Track your evaluations, goals, and professional development
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="mt-4">
              {metrics?.overdueEvaluations ? (
                <span className="text-xs text-red-600">
                  {metrics.overdueEvaluations} overdue
                </span>
              ) : (
        ...
        <Link href="/development-goals">
          <Card
            data-testid="development-goals-card"
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>
                Your evaluation history and feedback
              </CardDescription>
            </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground capitalize">
                        ...
                        {evaluation.managerName &&
                          `Manager: ${evaluation.managerName}`}
                      </p>
                    </div>
                  </div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Badge variant="outline">
              {upcomingTasks.filter((t) => t.priority === "high").length} high
              priority
            </Badge>
          </CardHeader>
          <CardContent className="space-y-4">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>
              Track progress on your professional development objectives
            </CardDescription>
          </div>
          <Button variant="outline" size="sm" asChild>
          ...
          {goalsLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-sm text-muted-foreground">
                Set goals to track your professional growth
              </p>
            </div>
          )}
        </CardContent>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-4">
            ...
            <Button
              variant="outline"
              asChild
              data-testid="view-meetings-button"
            >
              <Link href="/meetings">
                <Calendar className="h-4 w-4 mr-2" />
                View Meetings
